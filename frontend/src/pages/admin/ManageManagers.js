...
// import React, { useState, useEffect } from 'react';
// import axios from 'axios';
// import '../../styles/ManageManagers.css'; // Import the CSS file for styling
...
//     <div>
//       <h2>Manage Managers</h2>
//       <form onSubmit={isUpdating ? handleUpdateManager : handleAddManager} className="manager-form">
//         <div>
//           <label>Name:</label>
...
//               <button onClick={() => loadManagerDetails(manager)}>Update</button>
//               <button onClick={() => handleDeleteManager(manager._id)}>Delete</button>
//             </div>
//           ))
//         ) : (
